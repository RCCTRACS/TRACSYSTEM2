...
interface Subject {
  ...
  subject_name: string;
  subject_time: string;
  department?: string; // optional if needed
}
    ...
    const fetchTeacherData = async () => {
      ...
      try {
        const res = await fetch(
          `http://192.168.100.26/capstone/mainsystem/backend/get_teacher_subjects.php?email=${encodeURIComponent(
            effectiveEmail
          )}`
        );
      ...
      <div className="flex min-h-screen bg-white">
        ...
        <div className="flex-1">
          ...
          <CourseDetail
            ...
            department={selectedCourse.department || "General"} // placeholder
