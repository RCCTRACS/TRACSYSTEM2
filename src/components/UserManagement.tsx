        ...
        <div className="flex items-center gap-2">
          ...
          <Dialog open={isAddUserOpen} onOpenChange={setIsAddUserOpen}>
            <DialogTrigger asChild>
              <Button className={outlineDarkBrownBtn} onClick={() => setSelectedUser(null)}>
          ...
          <Table>
            ...
            <TableBody>
              {filteredUsers.map((user) => (
                <TableRow key={user.id} className="bg-admin-table-row hover:bg-admin-table-row-hover">
                  <TableCell className="font-medium">{user.name}</TableCell>
                  <TableCell>{user.email}</TableCell>
                  <TableCell>{user.department === "Teacher" && user.level ? user.level : user.department}</TableCell>
