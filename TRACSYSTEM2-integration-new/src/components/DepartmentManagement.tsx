...
import { FilterDialog } from "./FilterDepartmentDialog";
...
export function DepartmentManagement() {
  ...
  const outlineDarkBrownBtn = "bg-white text-black border-2 border-[#5C4033] rounded-md hover:bg-[#5C4033] hover:text-white";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button className={`${outlineDarkBrownBtn} flex items-center gap-2 rounded-full px-4 py-2`}>
        ...
        <div className="flex items-center gap-2">
          ...
          <Dialog open={isAddDepartmentOpen} onOpenChange={setIsAddDepartmentOpen}>
            <DialogTrigger asChild>
              <Button className={outlineDarkBrownBtn} onClick={() => setSelectedDepartment(null)}>
          ...
          <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
            ...
            <FilterDialog
              ...
              onApply={(filteredDeps) => setFilteredDepartments(filteredDeps)}
            />
          </Dialog>
        </div>
      </div>
        ...
        <CardContent>
          ...
          <div className="mt-2 space-y-3">
            {filteredDepartments.length === 0 ? (
              <div className="text-center text-gray-500 py-6">No departments found</div>
            ) : (
              filteredDepartments.map((dep) => (
                ...
                >
                  ...
                  <div className="flex justify-center gap-2">
                    <Button variant="ghost" size="sm" onClick={() => handleEditDepartment(dep)}>
                      <Edit className="h-4 w-4" />
                    </Button>
                    <Button variant="ghost" size="sm" onClick={() => handleDeleteDepartment(dep)}>
